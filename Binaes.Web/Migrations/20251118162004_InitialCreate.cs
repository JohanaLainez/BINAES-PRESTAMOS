        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopePrestamosActivos = table.Column<int>(type: "int", nullable: false),
                    MaxRenovaciones = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Carnet = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Nombre = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prestamos_Staff_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrestamoItems_Ejemplares_EjemplarId",
                        column: x => x.EjemplarId,
                        principalTable: "Ejemplares",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrestamoItems_Prestamos_PrestamoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrestamoItems_EjemplarId",
                table: "PrestamoItems",
                column: "EjemplarId");

            migrationBuilder.CreateIndex(
                name: "IX_PrestamoItems_PrestamoId",
                table: "PrestamoItems",
                column: "PrestamoId");

            migrationBuilder.CreateIndex(
                name: "IX_Prestamos_StaffId",
                table: "Prestamos",
                column: "StaffId");
